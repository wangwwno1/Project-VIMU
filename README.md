...
The enhanced PX4 source code is stored on Github in the [wangwwno1/Project-VIMU](https://github.com/wangwwno1/Project-VIMU) repository. To get the CI-PX4 onto your computer, enter the following command into a terminal:
